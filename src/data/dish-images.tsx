...
export const dishImages: Record<string, string> = {
  ...
  "Chicken Afritada": ChickenAfritada,
  "Fried Tilapia": FriedTilapia,
  "Jolibee Style Fried Chicken": JabeeChicken,
  "Chicken Tinola": ChickenTinola,
  "Fried Galunggong": FriedGalunggong,
  "Ginataang Kalabasa at Sitaw": GinataangKalabasa,
};
